# Generated by Django 2.1.3 on 2018-12-08 01:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='topics', to='BodhiAI_Blog_App.Category')),
            ],
        ),
        migrations.AddField(
            model_name='blog',
            name='topic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='BodhiAI_Blog_App.Topic'),
        ),
        migrations.AddField(
            model_name='blog',
            name='updated_by',
